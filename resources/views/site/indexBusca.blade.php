...
@section('container')
    <div class="container my-5">
        ...
        <div class="mb-5 d-flex">
            <h3 class="border-bottom border-dark pb-2">PRODUTOS ENCONTRADO PELA PESQUISA "{{$_GET['q']}}"</h3>
        </div>

        <div class="row">
            @foreach ($produtos as $produto)
                @include('components.singleProduct', ['produto' => $produto, 'class' => 'col-md-3', 'product_gtag_type' => 'Produtos pesquisados'])
            @endforeach
        </div>
