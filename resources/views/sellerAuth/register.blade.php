...
@section('seo')
    @php
        $seo = App\Models\SeoConfig::where('page', 'rsa-registroVendedor')->first();
    @endphp
@endsection
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-4">
                    <div class="row my-2">
                        ...
                        <div class="form-group col-12">
                            <input type="text" name="phone" value="{{old('phone')}}" class="form-control @error('phone') is-invalid @enderror" placeholder="Telefone/Celular">
                            @error('phone')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group col-12 text-center">
                            Já possui registro? <a class="link" href="{{route('seller.login')}}">Clique aqui!</a>
                        </div>
                        <div class="form-group col-12 text-center">
                            É comprador? <a class="link" href="{{route('register')}}">Clique aqui!</a>
                        </div>
                    </div>
                </div>
            </div>
