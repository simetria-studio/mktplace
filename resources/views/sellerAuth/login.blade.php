...
@section('seo')
    @php
        $seo = App\Models\SeoConfig::where('page', 'rsa-loginVendedor')->first();
    @endphp
@endsection
                    ...
                    <div class="row my-2">
                        ...
                        @if (session('success'))
                            <div class="col-12 mb-3">
                                <div class="py-2 text-center rounded alert-success">{!! session('success') !!}</div>
                            </div>
                        @endif
                        @if (session('status'))
                            <div class="col-12 mb-3">
                        ...
                        @if (session()->get('error'))
                            <div class="col-12 mb-3">
                                <div class="py-2 text-center rounded alert-danger">{{session()->get('error')}}</div>
                            </div>
                        @endif
                        ...
                        <div class="form-group col-12">
                            ...
                            <span style="font-size: .8rem;color:  #797979;">Esqueceu a senha? <a class="link" href="{{route('seller.forgot.password')}}">Clique aqui!</a></span>
                        </div>
                        ...
                        <div class="form-group col-12 text-center">
                            Não possui registro? <a class="link" href="{{route('seller.register')}}">Clique aqui!</a>
                        </div>
                    </div>
                </div>
            </div>
