            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{asset('/admin/comercial/pedidos')}}">Pedidos</a></li>
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body pad">
                            <div class="row">
                                ...
                                <div class="col-6 pt-3 px-2 text-right border-bottom">{{$order->order_number}} <a href="{{route('impressaoPedido', $order->order_number)}}" class="btn btn-info btn-sm ml-2" target="_blank">Imprimir</a></div>
                                ...
                                <div class="col-6 pt-3 px-2 text-right border-bottom">
                                    ...
                                    @else
                                        @if ($order->shippingCustomer->tracking_id)
                                            ...
                                            @endif
                                        @else
                                            <button type="button" class="btn btn-info btn-sm codigoAdd" data-url="{{route('admin.codigo_add')}}" data-order_number="{{$order->order_number}}">Adicionar Codigo</button>
                                        @endif
                                        <br>
                                        @php
