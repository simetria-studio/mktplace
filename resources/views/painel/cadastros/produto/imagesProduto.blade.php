<div class="m-2 position-relative" data-id="{{$image->id}}">
    <button type="button" class="btn btn-danger btn-sm btn-delete-foto" data-id="{{$image->id}}" data-url="{{\Request::url()}}?postProduct=true&postType=postDeleteFoto">X</button>
