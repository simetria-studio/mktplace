                            ...
                            <form action="#" method="post">
                                <div class="row justify-content-center">
                                    <div class="col-12 col-sm-8 input-group">
                                        <input type="text" class="form-control" name="titulo_turismo_rural_first" value="{{getTabelaGeral('titulos','titulo_turismo_rural_first')->valor??''}}">
                ...
                <div class="col-12">
                    <div class="card card-primary card-outline collapsed-card">
                        ...
                        <div class="card-header">
                            <h3 class="card-title">Eventos Ativos (Largura=400xAltura=400)</h3>
    ...
    <script>
        $(document).ready(function(){
            $(document).on('click', '.btn-save-local', function(){
                ...
                $.ajax({
                    url: `{{route('admin.eventoHomeRural.store')}}`,
                    type: "POST",
            ...
            $(document).on('click', '.btn-save-title', function(){
                ...
                var data = {
                    tabela: 'titulos',
                    coluna: 'titulo_turismo_rural_first',
                    valor: btn.closest('form').find('[name="titulo_turismo_rural_first"]').val(),
                };
