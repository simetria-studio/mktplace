            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{asset('/vendedor/comercial/assinaturas')}}">Assinaturas</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 pt-3 px-2 text-right border-bottom">
                                    @switch($assinatura->status)
                                        @case('1')
                                            Ativa <button class="btn btn-danger btn-sm btn-input-assinatura" data-toggle="modal" data-target="#solicitarCancelamentoAssinatura" data-signedplan_id="{{$assinatura->id}}"><i class="fas fa-times"></i> Cancelar</button>
                                            @break
                                        @case('2')
                                            Cancelada
                                            @break
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="#" method="post">
                    <input type="hidden" name="signedplan_id">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="button" class="btn btn-primary btn-cancelar-assinatura"><i class="fas fa-check"></i> Solicitar</button>
                    </div>
                </form>
            </div>
        </div>
