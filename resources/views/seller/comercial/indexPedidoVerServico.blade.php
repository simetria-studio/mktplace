            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{asset('/vendedor/comercial/pedidos-servicos')}}">Pedidos</a></li>
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body pad">
                            <div class="row">
                                ...
                                <div class="col-6 pt-3 px-2 text-right border-bottom">{{$order->order_number}} <a href="{{route('seller.impressaoPedidoServico', $order->order_number)}}" class="btn btn-info btn-sm ml-2" target="_blank">Imprimir</a></div>
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body pad">
                            <div class="row">
                                ...
                                <div class="col-12 pt-3 px-2">
                                    Data da Reserva {{date('d/m/Y', strtotime($order->serviceReservation->date_reservation))}} {{$order->serviceReservation->hour_reservation ? $order->serviceReservation->hour_reservation : ''}}
                                </div>
