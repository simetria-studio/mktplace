                                ...
                                <div class="row">
                                    <form action="" method="GET">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <a href="{{asset('vendedor/comercial/assinaturas')}}" class="btn btn-secondary ml-2">Limpar</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        @forelse ($assinaturas as $assinatura)
                                            <tr class="tr-plan-id-{{$assinatura->id}}">
                                                ...
                                                <td>
                                                    <a href="{{route('seller.assinaturaDetalhe', $assinatura->id)}}" class="btn {{$assinatura->status == 1 ? 'btn-primary' : 'btn-dark'}} btn-sm">Visualizar Assinatura</a>
                                                </td>
                                                <td>
