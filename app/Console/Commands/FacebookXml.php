...
class FacebookXml extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'facebook:xmlgenerate';
     ...
     * @var string
     */
    protected $description = 'Geração de xml do facebook';
    ...
    public function handle()
    {
        ...
        $file = fopen("public/facebook.xml", "w");
        fwrite($file, $xml);
        fclose($file);
