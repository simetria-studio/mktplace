...
class OrderFinish extends Mailable
{
    ...
    {
        return $this->markdown('emails.orderFinish')->with([
            'orders' => $this->order,
            'msg' => '
                ...
                <p style="text-align: center;"><h3><b>Você pode ajudar ainda mais ao avaliar o seu pedido em nosso site, assim mais pessoas conhecerão os produtos e poderão ajudar mais produtores/pequenos empresários.</b></h3></p>
                <br><br>
